...
-- for every goal scored. Modify it to show the player, teamid, stadium and mdate for 
-- every German goal.
...
-- Show player, teamid, coach, gtime for all goals scored in the first 10 minutes gtime<0
